...
const CodeBlock: FC<Props> = memo(({ language, value }) => {
  ...
  return (
    <div className="relative w-full font-sans codeblock bg-neutral-800 rounded-lg">
      <div className="flex rounded-lg items-center justify-between w-full px-6 py-1 pr-4 bg-neutral-700 text-zinc-100">
